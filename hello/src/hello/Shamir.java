...
public final class Shamir
{
        ...
        for(int formula = 0; formula < shares.length; formula++)
        {
            ...
            for(int count = 0; count < shares.length; count++)
            {
             ...
             // (numerator * -nextposition) % prime;
                ...
                // (denominator * (startposition - nextposition)) % prime;
    ...
    public static void main(final String[] args)
    {
        ...
        final SecretShare[] shares = Shamir.split(secret, 2, 10, prime, random);
        ...
        sharesToViewSecret = new SecretShare[] {shares[5],shares[9],shares[3]}; // 9 & 10 & 3
        result = Shamir.combine(sharesToViewSecret, prime);
    }
}