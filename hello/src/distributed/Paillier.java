package distributed;
	...
	*/
	...
	public static BigInteger getnn(){
		return nsquare;
	...
	*/
	...
	/* encryption*/
	BigInteger r = new BigInteger(bitLength, new Random());
	BigInteger em1 = paillier.Encryption(m1,r);
	BigInteger r2 = new BigInteger(bitLength, new Random());
	BigInteger em2 = paillier.Encryption(m2,r2);
	BigInteger r3 = new BigInteger(bitLength, new Random());
	BigInteger em3 = paillier.Encryption(m3,r3);
	BigInteger r4 = new BigInteger(bitLength, new Random());
	BigInteger em4 = paillier.Encryption(m4,r4);
	...
	System.out.println("--------------------------------------------------");
	System.out.println("compined ki by multipliaction and get K= "+ (em1.multiply(em2)).mod(paillier.nsquare));
